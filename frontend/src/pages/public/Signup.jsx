  ...
  return (
    <PageContainer className="d-flex align-items-center justify-content-center min-vh-100">
      <BrutalCard className="bg-white p-5 shadow-lg" style={{ maxWidth: '500px', width: '100%' }} hover={false}>
        ...
        <p className="text-center fw-bold text-muted mb-5 text-uppercase">
        ...
        <Form onSubmit={handleSignup}>
          ...
          <Form.Group className="mb-3">
            <Form.Label className="fw-black text-uppercase small">
              Full Name
            </Form.Label>
            <Form.Control
              type="text"
          ...
          {/* ✅ FIX: use type="submit" and remove preventDefault */}
          <BrutalButton
            type="submit"
            variant="primary"
            className="w-100 mb-3 fs-5 py-3"
          >
            Create Account
          </BrutalButton>
